...
public class Evento {
    ...
    public Evento(String nombre, LocalDate fecha, double precio, Recinto recinto, int inscritos) {
     ...
     * @return true si el número de inscritos es igual o mayor al aforo máximo.
     */
    public boolean estaLleno() {
        return inscritos >= recinto.getAforoMaximo();
    }
